...
export const noirShader = {
  name: 'noir',
  uniforms: {
    contrastAmt: { default: 1.2, min: 0, max: 2, label: 'Контраст' },
    grainAmt: { default: 0.5, min: 0, max: 1, label: 'Зернистость' },
    vignetteAmt: { default: 0.5, min: 0, max: 1, label: 'Виньетка' },
  },
  fragmentShader: /* glsl */ `
